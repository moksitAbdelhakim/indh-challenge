  ...
  const tinghirPrograms = [
    {
      id: 1,
      title: 'قطاع التعليم',
      image: '/assets/enseignement_primaire_tinghir.jpg',
      content: [
    ...
    },
    {
      id: 2,
      title: 'قطاع الصحة',
      image: '/assets/indh_sante_tinghir.jpg',
      content: [
    ...
    },
    {
      ...
      image: '/assets/femme_cooperative.jpg',
      content: [
    ...
    },
    {
      ...
      image: '/assets/INDH_tinghir_centre.jpg',
      content: [
    ...
    },
    {
      id: 5,
      title: 'برامج أخرى',
      image: '/assets/zaafarane-boulmane.jpg',
      content: [
